  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        ...
        // layout
        "fixed inset-0 z-50",
        // modern glassy backdrop
        "backdrop-blur-xl",
        "bg-[radial-gradient(circle_at_top,_rgba(148,163,184,0.25),_transparent_60%),_radial-gradient(circle_at_bottom,_rgba(129,140,248,0.18),_transparent_55%),_rgba(15,23,42,0.80)]",
        className
      )}
      {...props}
    />
